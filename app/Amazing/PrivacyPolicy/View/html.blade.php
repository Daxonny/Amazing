...
<section class="content">
	...
	<ol class="sections">
		<li>
			<p><a href="#section1">IMPORTANT INFORMATION AND WHO WE ARE</a></p>
		</li>
		<li>
			<p><a href="#section2">THE DATA WE COLLECT ABOUT YOU</a></p>
		</li>
		<li>
			<p><a href="#section3">HOW IS YOUR PERSONAL DATA COLLECTED</a></p>
		</li>
		<li>
			<p><a href="#section4">HOW WE USE YOUR PERSONAL DATA</a></p>
		</li>
		<li>
			<p><a href="#section5">DISCLOSURES OF YOUR PERSONAL DATA</a></p>
		</li>
		<li>
			<p><a href="#section6">INTERNATIONAL TRANSFERS</a></p>
		</li>
		<li>
			<p><a href="#section7">DATA SECURITY</a></p>
		</li>
		<li>
			<p><a href="#section8">DATA RETENTION</a></p>
		</li>
		<li>
			<p><a href="#section9">YOUR LEGAL RIGHTS</a></p>
		</li>
		<li>
			<p><a href="#section10">INFORMATION ABOUT OUR USE OF COOKIES</a></p>
		</li>
		<li>
			<p><a href="#section11">GLOSSARY</a></p>
		</li>
	</ol>

	<ol class="sectionPrivacy">
		<li>
			<h2 id="section1">Important information and who we are</h2>
		</li>


		<h3>Purpose of this privacy notice</h3>

		<p>This privacy notice aims to give you information on how Live Network collects and processes your personal data through your use of this website , including any data you may provide through this website when you sign up to our newsletter, request for commercial proposal or purchase a product or service.</p>
		...
		<p>You have the right to make a complaint at any time to the Directorate for Personal Data Protection (DPDP), the Macedonia supervisory authority for data protection issues <a href="https://www.dzlp.mk">https://www.dzlp.mks</a>. We would, however, appreciate the chance to deal with your concerns before you approach the DPDP so please contact us in the first instance.</p>
		...
		<li>
			<h2 id="section2">The data we collect about you</h2>
		</li>
		...
		<li>
			<h2 id="section3">How is your personal data collected?</h2>
		</li>
		...
		<li>
			<h2 id="section4">How we use your personal data</h2>
		</li>
		...
		<p>We will only use your personal data for the purposes for which we collected it, unless we reasonably consider that we need to use it for another reason and that reason is compatible with the original purpose.If you wish to get an explanation as to how the processing for the new purpose is compatible with the original purpose, please contact us</a></p>
		...
		<li>
			<h2 id="section5">Disclosures of your personal data</h2>
		</li>
		...
		<li>
			<h2 id="section8">Data retention</h2>
		</li>
		...
		<li>
			<h2 id="section9">Your legal rights</h2>
		</li>
		...
		<ul>
			<li>
				<p> <a href="#section16">Request access to your personal data.</a></p>
			</li>
			<li>
				<p> <a href="#section17">Request correction of your personal data.</a></p>
			</li>
			<li>
				<p> <a href="#section15">Request erasure of your personal data.</a></p>
			</li>
			<li>
				<p> <a href="#section18">Object to processing of your personal data.</a></p>
			</li>
			<li>
				<p> <a href="#section19">Request restriction of processing your personal data.</a></p>
			</li>
			<li>
				<p> <a href="#section20">Request transfer of your personal data.</a></p>
			</li>
			<li>
				<p> <a href="#section21">Right to withdraw consent.</a></p>
			</li>
		</ul>
		...
		<li>
			<h2 id="section10">Information about our use of cookies</h2>
		</li>
	...
	<p id="section13">Internal Third Parties</p>

	<p>Other companies in Live Network group of companies acting as joint controllers or processors and provide IT and system administration services and undertake leadership reporting. </p>

	<p id="section14">External Third Parties</p>
	...
	<p id="section16">Request access to your personal data (commonly known as a "data subject access request"). This enables you to receive a copy of the personal data we hold about you and to check that we are lawfully processing it.</p>

	<p id="section17">Request correction of the personal data that we hold about you. This enables you to have any incomplete or inaccurate data we hold about you corrected, though we may need to verify the accuracy of the new data you provide to us.</p>
